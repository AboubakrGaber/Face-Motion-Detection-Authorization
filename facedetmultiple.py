...
known_face_names = ["Authorized Person 1", "Authorized Person 2","Authorized Person 3"] #Add no. of authorized personnels
...
def main(video_source=0):
    ...
    image_paths = [ #Add your authorized faces here
        r"C:",
        r"C:",
        r"C:"
    ]
...
if __name__ == "__main__":
    main(r"") #Add path to recorded video here or live camera feed by using 0 instead of adding a video path
